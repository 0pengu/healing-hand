...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300",
  {
    variants: {
      variant: {
        default:
          "border border-black bg-company-blue-200 text-zinc-700 hover:bg-company-blue-400",
        secondary:
          "border border-black bg-company-yellow-200 text-zinc-700 hover:bg-company-yellow-500",
        destructive:
          "border border-black bg-red-500 text-zinc-50 shadow hover:bg-red-500/80 dark:bg-red-900 dark:text-zinc-50 dark:hover:bg-red-900/80",
        tertiary:
